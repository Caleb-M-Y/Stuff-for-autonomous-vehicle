...
$namedPt = Join-Path $exportDir "cyv8m-3-11.pt"
$namedOnnx = Join-Path $exportDir "cyv8m-3-11.onnx"
...
$logPath = Join-Path $exportDir "cyv8m-3-11-finalize.log"
$statusPath = Join-Path $exportDir "cyv8m-3-11-finalize.status"
